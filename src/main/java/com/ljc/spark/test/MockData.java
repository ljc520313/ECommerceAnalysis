...
import com.ljc.spark.util.DateUtils;
import com.ljc.spark.util.StringUtils;
		...
		for(int i = 0; i < 100; i++) {
			...
			for(int j = 0; j < 10; j++) {
				...
				for(int k = 0; k < random.nextInt(100); k++) {
					...
					String actionTime = baseActionTime + ":" + StringUtils.fullTwoDigits(String.valueOf(random.nextInt(59))) + ":" + StringUtils.fullTwoDigits(String.valueOf(random.nextInt(59)));
